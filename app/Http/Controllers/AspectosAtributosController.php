...
class AspectosAtributosController extends Controller
{
    ...
    {
        $nuevoaspecto = request()->except('_token', 'idAtributo');
        AspectosAtributos::insert($nuevoaspecto);
    ...
    {
        $datos['envio'] = AspectosAtributos::where('id','=', $id )->paginate();
        return view('Objetivos.AspectosAtributos',  $datos, compact('id'));
    }
