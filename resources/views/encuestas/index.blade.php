                                    ...
                                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        ...
                                        @else
                                            <table class="tabla-general">
                                                <thead>
                                                    <tr class="table100-head">
                                                        <th class="column1Atributos">Estatus</th>
                                                        <th class="column2Atributos">Evaluador</th>
                                                        <th class="column3Atributos">Carrera</th>
                                                        <th class="column4Atributos">Periodo</th>
                                                        <th class="column5Atributos">Residente</th>
                                                        <th class="column6Atributos">Acciones</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
