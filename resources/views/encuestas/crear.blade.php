                            ...
                            @foreach ($encuestas as $encuesta)
                                ...
                                <div class="accordion"  id="accordionExample{{$encuesta->id}}">
                                    <div class="card">
                                        ...
                                        <div id="collapse{{$encuesta->id}}" class="collapse" aria-labelledby="heading{{$encuesta->id}}" data-parent="#accordionExample{{$encuesta->id}}">
                                        <div class="card-body">
                                            ...
                                            <div class="accordion"  id="accordionExampleAspecto{{$aspecto->id}}">
                                                <div class="card">
                                                    ...
                                                    <div id="collapseAspecto{{$aspecto->id}}" class="collapse" aria-labelledby="headingAspecto{{$aspecto->id}}" data-parent="#accordionExampleAspecto{{$aspecto->id}}">
                                                    <div class="card-body">
                                                        <h4>Preguntas (Disponibles: {{$aspecto->preguntas->count()}})</h4>
