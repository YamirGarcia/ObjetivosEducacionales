                        ...
                        <tr class="table100-head">
                            ...
                            <th class="column2">
                                <button class="bg-transparent" style="border: none" wire:click="sortableObj('nombres')">
                                    ...
                                    <span class="fa fa{{ $campoObj === 'nombres' ? $iconObj : '-circle' }}"
                            ...
                            <th class="column3">
                                <button class="bg-transparent" style="border: none" wire:click="sortableObj('carrera')">
                                    ...
                                    <span class="fa fa{{ $campoObj === 'carrera' ? $iconObj : '-circle' }}"
                                        style="color: white"></span>
                                </button>
                            </th>
                            <th class="column3">
                                <button class="bg-transparent" style="border: none"
                                    wire:click="sortableObj('planEstudios')">
                                    <span style="color: white"> Plan de Estudios </span>
                                    <span class="fa fa{{ $campoObj === 'planEstudios' ? $iconObj : '-circle' }}"
                                        style="color: white"></span>
                                </button>
                            </th>
                            <th class="column4">
                                <button class="bg-transparent" style="border: none" wire:click="sortableObj('periodo')">
                                    ...
                                    <span class="fa fa{{ $campoObj === 'periodo' ? $iconObj : '-circle' }}"
                                        style="color: white"></span>
                                </button>
                            </th>
                            <th class="column6">
                                ...
                                <td class="column5">
                                    @if ($encuesta->estatus == 'contestada')
                                        <form action="{{ route('verRespuestas') }}" method="POST">
                                            ...
                                            <input type="text" name="idEncuestaAsignada" id="idEncuestaAsignada"
                                                value="{{ $encuesta->id }}" hidden>
                                            <input type="text" name="tipoEncuesta" id="tipoEncuesta" value="1" hidden>
                                        </form>
                                    @endif
                                </td>
                            </tr>
                ...
                <table class="tabla-general">
                    <thead>
                        <tr class="table100-head">
                            ...
                            <th class="column2">
                                <button class="bg-transparent" style="border: none"
                                    wire:click="sortableAtr('evaluadorNombre')">
                                    <span style="color: white "> Evaluador </span>
                                    <span class="fa fa{{ $campoAtr === 'evaluadorNombre' ? $iconAtr : '-circle' }}"
                                        style="color: white"></span>
                                </button>
                            </th>
                            <th class="column3">
                                <button class="bg-transparent" style="border: none" wire:click="sortableAtr('nombres')">
                                    ...
                                    <span class="fa fa{{ $campoAtr === 'nombres' ? $iconAtr : '-circle' }}"
                                        style="color: white"></span>
                                </button>
                            </th>
                            <th class="column4">
                                <button class="bg-transparent" style="border: none" wire:click="sortableAtr('carrera')">
                                    <span style="color: white "> Carrera </span>
                                    <span class="fa fa{{ $campoAtr === 'carrera' ? $iconAtr : '-circle' }}"
                                        style="color: white"></span>
                                </button>
                            </th>
                            <th class="column4">
                                <button class="bg-transparent" style="border: none"
                                    wire:click="sortableAtr('planEstudios')">
                                    <span style="color: white "> Plan de Estudios </span>
                                    <span class="fa fa{{ $campoAtr === 'planEstudios' ? $iconAtr : '-circle' }}"
                                        style="color: white"></span>
                                </button>
                            </th>
                            <th class="column5">
                                <button class="bg-transparent" style="border: none" wire:click="sortableAtr('periodo')">
                                    <span style="color: white "> Periodo </span>
                                    <span class="fa fa{{ $campoAtr === 'periodo' ? $iconAtr : '-circle' }}"
                                        style="color: white"></span>
                                </button>
                            </th>
                                ...
                                <td class="column6">
                                    @if ($encuesta->estatus == 'contestada')
                                        <form action="{{ route('verRespuestas') }}" method="POST">
                                            ...
                                            <input type="text" name="idEncuestaAsignada" id="idEncuestaAsignada"
                                                value="{{ $encuesta->id }}" hidden>
                                            <input type="text" name="tipoEncuesta" id="tipoEncuesta" value="2" hidden>
                                        </form>
                                    @endif
                                </td>
                            </tr>
