<div>
    ...
    <div class="row mb-4">
        <div style="display: flex">
            <button class="btn-clean" wire:click='clear' data-toggle="tooltip" data-placement="bottom" title="Limpiar" style="position: relative; top: 7px;">
            ...
            <tr class="table100-head">
                ...
                <td class="column5">
                    <div class="acciones">
                        ...
                        <form action="{{route ('evaluadores.destroy', [$evaluador->id])}}" method="POST" class="form-eliminar">
                            @method('DELETE')
                            @csrf
                        ...
                        <a href="#" data-toggle="modal" data-target="#modalVisualizarInfo{{$evaluador->id}}" >
