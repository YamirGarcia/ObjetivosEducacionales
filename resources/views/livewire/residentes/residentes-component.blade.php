<div>
    ...
    <nav>
        <div wire:ignore.self class="nav nav-tabs" id="nav-tab" role="tablist">
          <button wire:ignore.self class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Residentes</button>
          <button wire:ignore.self class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Pendientes</button>
        </div>
      </nav>
      <div wire:ignore.self class="tab-content" id="nav-tabContent">
        <div wire:ignore.self class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            <div class="row mb-4">
        ...
        <div wire:ignore.self class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
            <div class="row mb-4">
                ...
                <div style="display: flex">
                    <button class="btn-clean" wire:click='limpiarPen' data-toggle="tooltip" data-placement="bottom"
                        title="Limpiar">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="24" height="24" style="fill: #fff">
                            <path
                                d="M224 0H336C362.5 0 384 21.49 384 48V256H0V48C0 21.49 21.49 0 48 0H64L96 64L128 0H160L192 64L224 0zM384 288V320C384 355.3 355.3 384 320 384H256V448C256 483.3 227.3 512 192 512C156.7 512 128 483.3 128 448V384H64C28.65 384 0 355.3 0 320V288H384zM192 464C200.8 464 208 456.8 208 448C208 439.2 200.8 432 192 432C183.2 432 176 439.2 176 448C176 456.8 183.2 464 192 464z" />
                ...
                <div class="row">
                    <table>
                        <thead>
                            <tr class="table100-head">
                                <th class="column1">
                                    <button class="bg-transparent" style="border: none" wire:click="sortablePen('nombres')">
                                        <span style="color: white"> Nombres </span>
                                ...
                                <th class="column2">
                                    <button class="bg-transparent" style="border: none" wire:click="sortablePen('apellidos')">
                                        <span style="color: white"> Apellidos</span>
                                ...
                                <th class="column3">
                                    <button class="bg-transparent" style="border: none" wire:click="sortablePen('numeroControl')">
                                        <span style="color: white"> No. Control</span>
                                        <span class="fa fa{{ $campoPen === 'numeroControl' ? $iconPen : '-circle' }}"
                                            style="color: white"></span>
                                    </button>
                                </th>
                                <th class="column4">
                                    <button class="bg-transparent" style="border: none" wire:click="sortablePen('correo')">
                                        <span style="color: white"> Correo</span>
                                ...
                                <th class="column5">
                                    <button class="bg-transparent" style="border: none" wire:click="sortablePen('carrera')">
                                        <span style="color: white"> Carrera</span>
                        ...
                        <tbody>
                            ...
                            <tr class="table100-head">
                                ...
                                <td class="column6">
                                    <div class="acciones">
                                        @can('editar-residentes')
                                            <a href="{{ route('formularioResidentes.edit', $residente->id) }}">
