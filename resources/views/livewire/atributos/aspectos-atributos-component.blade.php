                ...
                <div class="col-lg-12">
                    <div class="card shadow p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <form wire:submit.prevent = 'crearAspecto'>
                                    @csrf
                                    <div class="row">
                                        <div class="col-10">
                                            <input type="text" class="form-control" style="margin-right: 1rem;"
                                                name="nombre" wire:model='nuevoAspecto'>
                                        </div>
                                    ...
                                    <div wire:ignore.self class="card card-accordion">
                                        <div wire:ignore.self class="card-header" id="heading{{ $aspecto->id }}">
                                            <h2 wire:ignore.self class="mb-0" style="display: flex">
                                                <button wire:ignore.self class="btn-acordion" type="button" data-toggle="collapse"
                                                ...
                                                <div wire:ignore.self class="acciones2">
                                                    <a wire:ignore.self href="#" data-toggle="modal" data-target="#modalEditarAspecto" wire:click = 'cargarAspecto({{$aspecto->id}})'>
                                                    ...
                                                    {{-- <form wire:submit.prevent = 'eliminarAspecto({{$aspecto->id}})'> --}}
                                                        ...
                                                        <button wire:ignore.self type="submit" style="border: none; background: none"
                                                            data-toggle="tooltip" data-placement="bottom" title="Eliminar" wire:click = 'eliminarAspecto({{$aspecto->id}})'>
                                        ...
                                        <div wire:ignore.self id="collapse{{ $aspecto->id }}" class="collapse"
                                            ...
                                            <div wire:ignore.self class="card-body">
                                                                    ...
                                                                    <td class="column3">
                                                                        <div class="acciones">
                                                                            ...
                                                                            <button class="btn-tabla"
                                                                                wire:click='borrarPregunta({{$pregunta->id}})' data-toggle="tooltip"
                                                ...
                                                <form wire:submit.prevent='crearPregunta({{$aspecto->id}})'>
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" class="form-control"
                                                                style="margin-right: 1rem;" name="Pregunta" wire:model='nuevaPregunta'>
                                                        </div>
                                                        <div class="col-1"
            ...
            <div wire:ignore.self class="modal fade" id="modalEditarAspecto" role="dialog" aria-hidden="true">
                <div class="modal-dialog" >
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Editar Aspecto Atributo</h5>
                ...
                <form wire:submit.prevent='guardarDatosAspecto'>
                    <div class="modal-body">
                        ...
                        <textarea name="nombre" class="form-control" id="nombre" rows="5" style="resize: none; height: 6rem;" wire:model='aspectoEditar' value='{{$aspectoEditar}}'></textarea>
                        ...
                        <div class="modal-footer">
                            <div class="col-xs-8 col-sm-12 col-md-15" style="left: -35px">
                                <button type="submit" class="boton-submit" wire:click="$emit('ocultarModalEditarAspecto')">Actualizar</button>
                            </div>
