        ...
        <div class="section-header">
            <h3 class="page__heading">
                ...
                <a style="text-decoration: none; color: #6c757d"
                    href="{{ route('Atributos.show', App\Models\Atributo::find($idAtributo)->carrera->id) }}">/Atributo</a>
                <a style="text-decoration: none; color: #6c757d"
                    ...
                    <div class="card shadow p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            <div class="">
                                ...
                                <div>
                                    <h3 class="mb-4">
                                        Atributo: {{ App\Models\Atributo::find($idAtributo)->descripcion }}
                                    </h3>
                                </div>
                                <hr>
                            </div>
                                                ...
                                                <div wire:ignore.self class="acciones2">
                                                    @can('editar-aspectosAtributos')
                                                        <a wire:ignore.self href="#" data-toggle="modal"
                                                            ...
                                                            wire:click='cargarAspecto({{ $aspecto->id }})'>
                                                    ...
                                                    @can('borrar-aspectosAtributos')
                                                        @if (App\Models\Atributo::find($idAtributo)->carrera->noBorrar == false)
                                                            <button wire:ignore.self type="submit"
                                                                ...
                                                                wire:click='eliminarAspecto({{ $aspecto->id }})'>
                ...
                <form wire:submit.prevent='guardarDatosAspecto'>
                    <div class="modal-body">
                        ...
                        <textarea name="nombre" class="form-control" id="nombre" rows="5" style="resize: none; height: 6rem;"
                            wire:model='aspectoEditar' value='{{ $aspectoEditar }}'></textarea>
