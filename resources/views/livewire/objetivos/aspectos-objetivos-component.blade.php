                      ...
                      <div wire:ignore.self class="card card-accordion" >
                          <div wire:ignore.self class="card-header" id="heading{{$aspecto->id}}">
                            <h2 wire:ignore.self class="mb-0" style="display: flex">
                              <button wire:ignore.self class="btn-acordion" type="button" data-toggle="collapse" data-target="#collapse{{$aspecto->id}}" aria-expanded="true" aria-controls="collapse{{$aspecto->id}}" style="text-decoration: none">
                              ...
                              <div wire:ignore.self class="acciones2">
                                  ...
                                  {{-- <form wire:prevent.submit="eliminarAspecto({{$aspecto->id}})""> --}}
                                      <button wire:ignore.self style="border: none; background: none" wire:click="$emit('eliminarAspectoModal', {{$aspecto->id}})" data-toggle="tooltip" data-placement="bottom" title="Eliminar">
                          ...
                          <div wire:ignore.self id="collapse{{$aspecto->id}}" class="collapse" aria-labelledby="heading{{$aspecto->id}}" data-parent="#accordionExample{{$aspecto->id}}">
                            <div wire:ignore.self class="card-body">
                                ...
                                <table  class="tabla-general mb-4">
                                    ...
                                    <td class="column3">
                                        <div class="acciones">
                                            <a href="#" data-toggle="modal" data-target="#modalEditarPregunta" wire:click="cargarDatosPregunta({{$preguntaAsp->id}})">
                                            ...
                                            <button class="btn-tabla" wire:click='borrarPregunta({{$preguntaAsp->id}})' data-toggle="tooltip" data-placement="bottom" title="Eliminar">
