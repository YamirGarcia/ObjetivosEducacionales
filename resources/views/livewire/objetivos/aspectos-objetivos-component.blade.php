                          ...
                          <div wire:ignore.self class="card-header" id="heading{{$aspecto->id}}">
                            <h2 wire:ignore.self class="mb-0" style="display: flex">
                              ...
                              <div wire:ignore.self class="acciones">
                                  <a wire:ignore.self href="#" data-toggle="modal" data-target="#modalEditar" wire:click="cargarDatosAspecto({{$aspecto->id}})">
                                  ...
                                  {{-- <form wire:prevent.submit="eliminarAspecto({{$aspecto->id}})""> --}}
                                      <button wire:ignore.self style="border: none; background: none" wire:click="eliminarAspecto({{$aspecto->id}})">
