                                                ...
                                                <div class="card-img bg-card-blue">
                                                    <div class="info">
                                                        ...
                                                        <h4 class="text-cent" style="font-size: 40px !important">
                                                            {{ $usuario->rol == 'Administrador' ? count(App\Models\User::where([['rol','!=','Evaluador'], ['creadopor','!=', 'SuperAdmin']])->get())  : count(App\Models\User::where([['creadopor', $usuario->name], ['rol','!=','Evaluador']])->get()) }}
                                                        </h4>
                                                    </div>
