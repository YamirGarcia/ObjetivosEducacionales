    ...
    <ul class="navbar-nav navbar-right">
        ...
        <span class="navbar-text text-center titulo"
            style="position:absolute; left: calc((100% - 400px) / 2); width: 400px;">Instituto Tecnológico de
            Morelia</span>
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item has-icon" data-toggle="modal" data-target="#changePasswordModal" href="#"
                        data-id="{{ \Auth::id() }}"><i class="fa fa-lock" style="color: black"> </i>Cambiar
                        Contraseña</a>
