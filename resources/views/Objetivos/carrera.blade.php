                                                    ...
                                                    <div class="acciones">
                                                        @can('editar-carrera')
                                                            <a href="#" data-toggle="modal"
                                                                data-target="#modalEditar{{ $carrera->id }}">
                                                        ...
                                                        @can('ver-objetivos')
                                                            <form
                                                                action="{{ route('ObjetivoEducacional.show', $carrera->id) }}"
                                                                method="GET">
                                                                @csrf
                                                                <button class="btn-tabla" type="submit">
                                                                    ...
                                                                    <label class="etiqueta-objetivos">Objetivo
                                                                        Educacional</label>
                                                                </button>
                                                            </form>
                                                        @endcan
                                                        <form action="{{ route('Atributos.show', $carrera->id) }}">
                                                            <button class="btn-tabla" type="submit">
                                                                ...
                                                                <label class="etiqueta">Atributoss</label>
                                                            </button>
                                                        </form>
                                                    </div>
                                                </td>
