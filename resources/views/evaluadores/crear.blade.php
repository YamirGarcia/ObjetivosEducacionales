...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading"><a style="text-decoration: none; color: #6c757d" href="/evaluadores">Evaluadores</a>
                <a style="text-decoration: none; color: #6c757d" href="{{ route('evaluadores.create') }}">/
                    Crear Evaluador</a>
            </h3>
        </div>
                ...
                <div class="col-lg-12" style="margin: 0 auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('nombres', null, ['class' => 'form-control', 'pattern' => '[a-zA-Z ]{2,254}']) !!}
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for="apellidos">Apellidos</label>
                                        {!! Form::text('apellidos', null, ['class' => 'form-control', 'pattern' => '[a-zA-Z ]{2,254}']) !!}
                                    </div>
                                </div>
                            </div>
                            {{--  --}}
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('idDepartamento', null, ['class' => 'form-control', 'pattern' => '[a-zA-Z ]{2,254}']) !!}
                                    </div>
                                </div>
                            </div>
                            {{--  --}}
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('telefono', null, ['class' => 'form-control', 'pattern' => '^\d{10}$']) !!}
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('correo', null, ['class' => 'form-control', 'pattern' => "^[a-z0-9!#$%&'+/=?^_`{|}~-]+(?:.[a-z0-9!#$%&'+/=?^_`{|}~-]+)@(?:[a-z0-9](?:[a-z0-9-][a-z0-9])?.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$"]) !!}
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                            ...
                            {{--  --}}
                            <input type="text" readonly name="creadopor" class="form-control" style="visibility: hidden;"
