<a href="" class="btn-flotante" style="bottom:120px;" data-toggle="modal" data-target="#modalGrupoInteres">Grupos de
    Interes</a>
        ...
        <div class="modal-content">
                ...
                <table>
                    <thead>
                        <tr class="table100-head-modal">
                            <th class="column1-modal"">Grupo de Interes</th>
                                        <th class=" column2-modal"">Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($envio as $grupoI)
                            <tr class="table100-head-modal">
                                <td class="column1-modal">{{ $grupoI->nombre }}</td>
                                <td class="column2-modal">
                                    <div class="acciones">
                                        <button class="btn-tabla" data-toggle="modal"
                                            data-target="#modalEditar{{ $grupoI->id }}">
            ...
            <div class="modal-footer">
                ...
                <div class="col-xs-8 col-sm-12 col-md-15" style="left: -35px">
                    <button type="submit" class="boton-submit" data-toggle="modal"
...
@foreach ($envio as $grupoI)
    <div class="modal fade" id="modalEditar{{ $grupoI->id }}">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="{{ url('GrupodeInteres/' . $grupoI->id) }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control" name="nombre" style="margin-bottom: 2rem;"
                            pattern='[a-zA-Z ]{2,254}' value="{{ $grupoI->nombre }}">
                        <input type="text" class="form-control" name="id"
                            style="margin-bottom: 2rem; visibility: hidden;" value="{{ $grupoI->id }}">
                    </div>
                    <div class="modal-footer">
                        <div class="col-xs-8 col-sm-12 col-md-15" style="left: -35px">
                            <button type="submit" class="boton-submit">Actualziar</button>
                        </div>
                    </div>
                </form>
            </div>
