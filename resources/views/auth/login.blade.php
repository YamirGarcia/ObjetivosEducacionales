...
@section('content')
    ...
    <div class="card login__form" style="width: 100%; position: relative; left: 0;">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <input aria-describedby="emailHelpBlock" id="email" type="email"
                        ...
                        placeholder="Ingresa Correo" tabindex="1"
                ...
                <div class="form-group" style="align-items: center">
                    <div class="col" style="align-items: center">
                        <button type="submit" class="boton-submit" style="width: 40%; margin-left: 30%;">Iniciar Sesión</button>
                    </div>
{{-- 
